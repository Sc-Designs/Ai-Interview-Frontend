...
const DashboardOrg = ({data}) => {
  return (
    <div className="flex items-center justify-center mt-4 gap-x-10">
      ...
      <div className="flex flex-col px-6 py-2 text-lg gap-y-1 rounded-2xl font-Satoshi">
        <h1 className="text-zinc-500">
          Company Name:{" "}
          <span className="ml-5 font-semibold text-zinc-200">{data.name}</span>
        </h1>
        <h3 className="text-zinc-500">
          Company ID:{" "}
          <span className="ml-5 font-semibold text-zinc-200">{data._id}</span>
        </h3>
        <h5 className="text-zinc-500">
          Company Joined:{" "}
          <span className="ml-5 font-semibold text-zinc-200">
        ...
        <h6 className="text-zinc-500">
          Company Domain:{" "}
          <a
            className="ml-5 font-semibold text-sky-600"
            href={data.domain || "#"}>
            {data.domain || "Null"}
          </a>
        </h6>
        <h6 className="text-zinc-500">
          Company Email:{" "}
          <span className="ml-5 font-semibold text-zinc-200">{data.email}</span>
        </h6>
        <h6 className="text-zinc-500">
          Company Phone No.:{" "}
          <span className="ml-5 font-semibold text-zinc-200">
