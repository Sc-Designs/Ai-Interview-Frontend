    ...
    <div className="flex justify-center w-full min-h-screen bg-zinc-950">
      <div className="w-[20%] flex flex-col pt-5 gap-y-2 items-center h-screen bg-zinc-900">
        ...
        <div className="text-sm text-white font-Satoshi">
          <p>
            Name: - <span className="text-zinc-400">Suvam Chakraborti</span>
          </p>
          <p>
            Email: -{" "}
            <span className="text-zinc-400">nfgaming4523@gmail.com</span>
          </p>
          <p>
            Phone: - <span className="text-zinc-400">+91 8001165553</span>
          </p>
          <p>
            ID: - <span className="text-zinc-400">28324h753hul4p9h2urh9p</span>
          </p>
          <p>
        ...
        <div className="flex flex-col items-center w-full mt-5 text-white uppercase">
          <h1 className="relative w-full py-4 text-center cursor-pointer after:absolute after:w-full after:h-full after:bg-yellow-500 after:top-0 after:left-[-100%] after:opacity-0 hover:after:opacity-100 hover:after:left-0 after:transition-all after:duration-500 border-t-1 border-white/20">
      ...
      <div className="w-[80%] h-screen px-10 py-6">
        ...
        {selectedTab === "home" ? <HomeGraph /> : selectedTab === "user" ? <UserGraph /> : <OrganizationGraph />}
      </div>
    </div>
  );
}
