...
const Admin = () => {
  ...
  return (
    <div className="flex justify-center w-full min-h-screen bg-zinc-950">
      <div className="w-[20%] hidden lg:flex flex-col pt-5 gap-y-2 items-center h-screen bg-zinc-900">
        <ShinyText
          text="Admin Panel"
          disabled={false}
          speed={5}
      ...
      <div className={`w-[40%] fixed z-50 transition-all duration-200 ${showMenu ? "left-0" : "-left-[100%]"} lg:hidden flex flex-col pt-5 gap-y-2 items-center h-screen bg-zinc-900`}>
        <IoClose onClick={()=>setShowMenu(false)} className='absolute text-2xl text-white cursor-pointer right-5' />
        <ShinyText
          text="Admin Panel"
          disabled={false}
          speed={5}
      ...
      <div className="md:w-[100%] lg:w-[80%] h-screen px-10 py-6">
        <div className="flex justify-between w-full">
          <h1 className="flex items-center text-3xl font-semibold gap-x-4 text-white/50 font-Okomito">
            <HiOutlineMenuAlt4 onClick={()=>setShowMenu(true)} className='block text-white cursor-pointer lg:hidden' />Dashboard
          </h1>
